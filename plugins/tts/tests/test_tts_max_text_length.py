...
class TestTextToSpeechToolTruncation:
    ...
    def test_openai_truncates_at_4096_not_4000(self, tmp_path, monkeypatch, caplog):
        ...
        monkeypatch.setattr("hermes_agent_tts.tts_tool._generate_openai_tts", fake_openai)
        monkeypatch.setattr("hermes_agent_tts.tts_tool._load_tts_config",
                            lambda: {"provider": "openai"})

        from hermes_agent_tts.tts_tool import text_to_speech_tool
    ...
    def test_xai_accepts_much_longer_input(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("hermes_agent_tts.tts_tool._generate_xai_tts", fake_xai)
        monkeypatch.setattr("hermes_agent_tts.tts_tool._load_tts_config",
                            lambda: {"provider": "xai"})
