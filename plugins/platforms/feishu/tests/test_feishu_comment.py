...
from hermes_agent_feishu.feishu_comment import (
...
class TestEventFiltering(unittest.TestCase):
    ...
    @patch("hermes_agent_feishu.feishu_comment_rules.load_config")
    @patch("hermes_agent_feishu.feishu_comment_rules.resolve_rule")
    @patch("hermes_agent_feishu.feishu_comment_rules.is_user_allowed")
    def test_self_reply_filtered(self, mock_allowed, mock_resolve, mock_load):
        ...
        from hermes_agent_feishu.feishu_comment import handle_drive_comment_event
...
class TestAccessControlIntegration(unittest.TestCase):
    ...
    @patch("hermes_agent_feishu.feishu_comment_rules.has_wiki_keys", return_value=False)
    @patch("hermes_agent_feishu.feishu_comment_rules.is_user_allowed", return_value=False)
    @patch("hermes_agent_feishu.feishu_comment_rules.resolve_rule")
    @patch("hermes_agent_feishu.feishu_comment_rules.load_config")
    def test_denied_user_no_side_effects(self, mock_load, mock_resolve, mock_allowed, mock_wiki_keys):
        ...
        from hermes_agent_feishu.feishu_comment import handle_drive_comment_event
        from hermes_agent_feishu.feishu_comment_rules import ResolvedCommentRule
...
class TestWikiReverseLookup(unittest.TestCase):
    ...
    @patch("hermes_agent_feishu.feishu_comment._exec_request")
    ...
    @patch("hermes_agent_feishu.feishu_comment._reverse_lookup_wiki_token", new_callable=AsyncMock)
    @patch("hermes_agent_feishu.feishu_comment_rules.has_wiki_keys", return_value=True)
    @patch("hermes_agent_feishu.feishu_comment_rules.is_user_allowed", return_value=True)
    @patch("hermes_agent_feishu.feishu_comment_rules.resolve_rule")
    @patch("hermes_agent_feishu.feishu_comment_rules.load_config")
    @patch("hermes_agent_feishu.feishu_comment.add_comment_reaction", new_callable=AsyncMock)
    @patch("hermes_agent_feishu.feishu_comment.batch_query_comment", new_callable=AsyncMock)
    @patch("hermes_agent_feishu.feishu_comment.query_document_meta", new_callable=AsyncMock)
